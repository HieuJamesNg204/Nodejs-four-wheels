...
import { addNewCar, getAllCars, getCarById, updateCar, deleteCar, getCarsByAutomaker, getCarsByPriceRange } from '../controllers/carController.js';
...
router.get('/getByPriceRange/:id', getCarsByPriceRange);
